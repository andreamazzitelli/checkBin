...
### Edge computing
We could use the edge to run a machine learning algorithm which learn and adjust some relevant parameters like: the interval between measurementsor the specific weights of every waste type.
